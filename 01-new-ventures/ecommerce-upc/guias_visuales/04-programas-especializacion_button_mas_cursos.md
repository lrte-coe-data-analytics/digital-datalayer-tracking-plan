...
**Payload General:** [../04-programas-especializacion/button_mas_cursos.yaml](../04-programas-especializacion/button_mas_cursos.yaml)
...
```yaml
{
  ...
  "ui_hierarchy": "programas_especializacion",   # Identificador semantico de la seccion donde se ubica.
