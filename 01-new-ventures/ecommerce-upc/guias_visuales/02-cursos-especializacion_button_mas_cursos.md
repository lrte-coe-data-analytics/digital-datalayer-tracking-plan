...
**Payload General:** [../02-cursos-especializacion/button_mas_cursos.yaml](../02-cursos-especializacion/button_mas_cursos.yaml)
...
```yaml
{
  ...
  "ui_hierarchy": "cursos_especializacion",   # Identificador semantico de la seccion donde se ubica.
