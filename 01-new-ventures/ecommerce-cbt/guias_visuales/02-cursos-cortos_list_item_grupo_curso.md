...
**Payload General:** [../02-cursos-cortos/list_item_grupo_curso.yaml](../02-cursos-cortos/list_item_grupo_curso.yaml)
...
```yaml
{
  ...
  "ui_hierarchy": "cursos_cortos > domina_habilidades",   # Identificador semantico de la seccion donde se ubica.
