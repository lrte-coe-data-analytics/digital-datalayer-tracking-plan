...
**Payload General:** [../04-certificaciones/button_mas_cursos.yaml](../04-certificaciones/button_mas_cursos.yaml)
...
```yaml
{
  ...
  "ui_hierarchy": "certificaciones_internacionales",   # Identificador semantico de la seccion donde se ubica.
