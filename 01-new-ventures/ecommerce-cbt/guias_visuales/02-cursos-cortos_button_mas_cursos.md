...
**Payload General:** [../02-cursos-cortos/button_mas_cursos.yaml](../02-cursos-cortos/button_mas_cursos.yaml)
...
```yaml
{
  ...
  "ui_hierarchy": "cursos_cortos",    # Identificador semantico de la seccion donde se ubica.
