...
**Payload General:** [../04-informativo/screen_view.yaml](../04-informativo/screen_view.yaml)
...
```yaml
{
  ...
  "screen_name"   : "menu_informativo",   # Nombre legible (Ej: "Home", "Zona cachimbos")
  "screen_type"   : "dashboard",          # Tipo técnico de la pantalla
  "screen_section": "informativo",        # Agrupación temática macro (Content Group)
  "category_l1"   : null,
  "category_l2"   : null,
  "category_l3"   : null,
