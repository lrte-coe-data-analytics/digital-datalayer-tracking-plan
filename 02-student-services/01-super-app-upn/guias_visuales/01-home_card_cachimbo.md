...
**Payload General:** [../01-home/card_cachimbo.yaml](../01-home/card_cachimbo.yaml)

---
## Instancia: card_cachimbo
- **Descripción:** Captura la interacción de **click** del usuario con el card relacionado a **Cachimbo UPN**.
...
```yaml
{
  ...
  "ui_label"    : "cachimbo_upn",     # Esto debe enviar el texto principal del elemento
