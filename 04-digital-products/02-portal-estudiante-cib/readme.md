...
- 📘 ```: [payload](../06-documentos/.yaml) | [guía visual](./guias_visuales/06-documentos_.md)
...
- 📘 `Click/dowloand-Documentos`: [payload](../06-documentos/click_dowloand_documentos.yaml) | [guía visual](./guias_visuales/06-documentos_click_dowloand_documentos.md)
...
- 📘 `session_start`: [payload](../00-login/session_start.yaml) | [guía visual](./guias_visuales/00-login_session_start.md)
    **Descripción:** Este evento mide el inicio de una sesión.

- 📘 `user_engagement`: [payload](../00-login/user_engagement.yaml) | [guía visual](./guias_visuales/00-login_user_engagement.md)
