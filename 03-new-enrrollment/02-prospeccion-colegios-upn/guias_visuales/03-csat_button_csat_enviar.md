...
```yaml
{
  ...
  "ui_hierarchy"    : "home > {{seccion_actual}} > csat",            # Identificador semantico de la seccion donde se ubica. Para el nivel del evento son 3 (personalidad,intereses y habilidades) y el n_pregunta debe ir con zero-padding (ej. pregunta_01).
