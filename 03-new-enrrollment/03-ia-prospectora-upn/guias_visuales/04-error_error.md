...
---
## Instancia: entendido
- **Descripción:** Cuando se despliega una ventana modal de error (Formato no compatible) y el usuario hace clic en el botón "Entiendo".

![entendido](../assets/04-error_error.png)
