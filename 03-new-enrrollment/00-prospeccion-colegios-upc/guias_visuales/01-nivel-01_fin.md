# Guía Visual: Fin (01-nivel-01)
**Payload General:** [../01-nivel-01/fin.yaml](../01-nivel-01/fin.yaml)
...
```yaml
{
  ...
  "ui_hierarchy"       : "home > nivel_01",                          # Identificador semántico de la sección donde se ubica. (En este caso es Nivel 1)
